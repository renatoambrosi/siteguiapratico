// utm-tracker.js - Sistema de rastreamento de UTMs
(function() {
    'use strict';
    ...
    const utmSource = currentQuery.utm_source || getOrSetSession('utm_source', null) || 'LpGuia';
    ...
    function processLinks() {
        ...
        // Checkout: todos os links para pay.kiwify.com.br/itNhMPe
        const checkoutLinks = document.querySelectorAll('a[href*="pay.kiwify.com.br/itNhMPe"]');

        checkoutLinks.forEach(link => {
            const baseUrl = link.getAttribute('href');

            // Cria utm_campaign baseado no contexto do link
            let utmCampaign = 'LpGuia';

            if (link.closest('.hero')) {
                utmCampaign = 'LpGuia-hero';
            } else if (link.closest('.cta-section')) {
                utmCampaign = 'LpGuia-cta';
            } else if (link.classList.contains('btn-header')) {
                utmCampaign = 'LpGuia-header';
            }

            const utmParams = {
                utm_source: sessionStorage.getItem('utm_source') || 'LpGuia',
            ...
            // Atualiza o link no carregamento
        ...
        // Home links (HEADER + FOOTER): todos links para suellenseragi.com.br
        const homeLinks = document.querySelectorAll('a[href*="suellenseragi.com.br"]');
